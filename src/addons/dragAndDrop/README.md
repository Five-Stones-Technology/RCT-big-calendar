...
```js
import { Calendar } from 'fs-big-calendar'
import withDragAndDrop from 'fs-big-calendar/lib/addons/dragAndDrop'
import 'fs-big-calendar/lib/addons/dragAndDrop/styles.css'
